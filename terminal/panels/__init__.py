...
from . import arbitrage, etf, macro, news, orderbook, perp, price

PANELS = (price, orderbook, arbitrage, etf, perp, news, macro)

__all__ = ["PANELS", "price", "orderbook", "arbitrage", "etf", "perp",
           "news", "macro"]
